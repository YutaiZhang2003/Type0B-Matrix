...
\ie
\bpzbraket{ \mathbf{L}_{-A} \phi  \otimes \widetilde{\mathbf{L}}_{-\widetilde{A}} \widetilde{\phi} }{ \mathbf{L}_{-B} \phi \otimes  \widetilde{\mathbf{L}}_{-\widetilde{B}} \widetilde{\phi}} =(-1)^{(B+p_{\phi})(A+p_{\widetilde{\phi}})}\bpzbraket{\mathbf{L}_{-A} \phi}{\mathbf{L}_{-B} \phi } \times \bpzbraket{ \widetilde{\mathbf{L}}_{-\widetilde{A} }\widetilde{\phi}}{ \widetilde{\mathbf{L}}_{-\widetilde{B}}\widetilde{\phi}}.
\fe
...
\ie
\rho_a(\mathbf{L}_{-A}\chi_{rs} , \mathbf{L}_{-B}\phi_2,  \mathbf{L}_{-C}\phi_3) = (-1)^{rsC} \begin{cases} \rho_{a}(\mathbf{L}_{-A}\phi_{h_{rs}+\frac{rs}{2}} , \mathbf{L}_{-B}\phi_2,  \mathbf{L}_{-C}\phi_3) \mathbf{P}_{rs}^a(h_3, h_2),\quad rs\in 2\mathbb{Z}, \\ 
\rho_{1-a}(\mathbf{L}_{-A}\phi_{h_{rs}+\frac{rs}{2}} , \mathbf{L}_{-B}\phi_2,  \mathbf{L}_{-C}\phi_3) \mathbf{P}_{rs}^{a}(h_3, h_2),\quad rs\in 2\mathbb{Z}+1,
\end{cases}
\fe
...
\ie
& \hat{\rho}_a\left(u_1 \otimes x_1, u_2 \otimes x_2, u_3 \otimes x_3\right)=(-1)^{\left|x_1\right|\left(\left|u_2\right|+\left|u_3\right|\right)+\left|x_2\right|\left|u_3\right|+a |u_3|} \rho^{\mathsf{F}}(u_1, u_2, u_3) \rho_a(x_1, x_2, x_3),
\fe
where $\rho^{\mathsf{F}}(u_1, u_2, u_3)$ is the normalized 3-point function in the free fermion theory.  The sign $(-1)^{\left|x_1\right|\left(\left|u_2\right|+\left|u_3\right|\right)+\left|x_2\right|\left|u_3\right|+a \left|u_3\right|}$ comes from moving operator order. Importantly, $\rho^{\mathsf{F}}$ is only nonzero if $\mathsf{A}+\mathsf{B}+\mathsf{C}\equiv 0$ mod 2. If we define the free fermion block as
\ie
