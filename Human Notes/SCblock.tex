...
\subsubsection*{Conformal Block Decomposition of Genus 2 Partition Function}

For illustration, we consider a 2d \(\mathcal N=(1,1)\) superconformal field theory and derive the conformal-block decomposition of its genus-two partition function. The final result present a nice holomorphic factorialization structure after keeping track of the signs in the computation.
...
\ie \label{NSblock}
\mathbf{F}^{\Theta}_a(h_1, h_2, h_3, c)= & \sum_{|A|=|B|,|C|=|D|,|E|=|F|, (-1)^{A+C+E}=(-1)^a} q_1^{|A|}\eta_1^A q_2^{|C|} \eta_2^C q_3^{|E|} \eta_3^E \mathbf{G}_{h_1}^{A B} \mathbf{G}_{h_2}^{C D} \mathbf{G}_{h_3}^{E F} \\
...
+(A+p_1+a)(\widetilde A+\widetilde p_1+a)
+(C+p_2+a)(\widetilde C+\widetilde p_2+a)
}
D_1D_2D_3
...
\right).
\fe
where $a\equiv E+p_3\equiv \widetilde{E}+\tilde p_3 \pmod 2$.
...
\\
&\times
C_{131}^{(a)}C_{232}^{(a)} ~(-1)^{a+K_{\mathrm{Gl}}+\widetilde K_{\mathrm{Gl}}}
~\mathbf G_{h_1}^{AB}
\mathbf G_{h_2}^{CD}
\mathbf G_{h_3}^{EF}
\widetilde{\mathbf G}_{\widetilde h_1}^{\widetilde A\widetilde B}
...
\ie
 \label{NSblock}
\mathbf{F}^{\mathrm{Gl}}_a(h_1, h_2, h_3, c)= & \sum_{|A|=|B|,|C|=|D|,|E|=|F|, (-1)^{E+p_3}=(-1)^a} q_1^{|A|}\eta_1^A q_2^{|C|} \eta_2^C q_3^{|E|} \eta_3^E \mathbf{G}_{h_1}^{A B} \mathbf{G}_{h_2}^{C D} \mathbf{G}_{h_3}^{E F} \\
...
\ie
Z_{g=2} = \sum_{\mathcal{O}_1,\mathcal{O}_2,\mathcal{O}_3} \sum_{a=0,1}  \left(C^{(a)}_{131} C^{(a)}_{232}  \right) (-1)^a \prod_{i=1}^{3}
q_i^{h_i}\widetilde q_i^{\widetilde h_i}F^{\mathrm{Gl}}_a(h_1, h_2, h_3, c) \widetilde{F}^{\mathrm{Gl}}_a (\tilde{h}_1,\tilde{h}_2, \tilde{h}_3, \tilde{c}).
\fe
