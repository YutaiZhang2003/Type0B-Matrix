...
def reduced_numerator(b, momenta, level, *, f=0, p=0, etas=(1,-1),
    ...
    shared_actions = outer.middle_actions(dps)
...
def main():
    ...
    def save_branching(values):
        saved = {"status":"branching coefficients computed",
                 "parameters":{key:report[key] for key in ("total_q_level","b","momenta","p","f","etas","ccy_dps","ward_dps")},
    ...
    numerator,diagnostics = reduced_numerator(
        ...
        branching_checkpoint=save_branching)
