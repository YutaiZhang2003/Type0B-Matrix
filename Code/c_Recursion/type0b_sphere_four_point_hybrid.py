#!/usr/bin/env python3
r"""Type-0B sphere four-point amplitude (historical hybrid module name).
...
defaults to fixed-weight ``c`` recursion in every chart, including bulk and
local plumbing collars. Explicit h/hybrid selections remain research-only;
the amplitude command-line drivers always select c-recursion.
