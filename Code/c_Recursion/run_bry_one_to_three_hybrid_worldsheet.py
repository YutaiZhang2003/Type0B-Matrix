#!/usr/bin/env python3
"""Target-blind BRY 1->3 integral with all-c recursion.

Every chart uses component-aware c-recursion; the historical script name
and inactive hybrid options are retained for compatibility.
BRY's leading t-channel OPE polynomial is
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(
        f"all-c worldsheet: nodes={len(tasks)}, workers={args.workers}, "
        f"q^{args.q_order}",
        flush=True,
    )
    if args.workers == 1:
    ...
    payload = {
        ...
        "recursion_atlas": {
            "block_backend": "c",
            "bulk": "component-aware c recursion",
            "bulk_gate": None,
            "corners": "component-aware c recursion",
