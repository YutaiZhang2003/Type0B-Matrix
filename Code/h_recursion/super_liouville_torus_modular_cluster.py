...
IMPLEMENTATION_SOURCE_FILES = (
    "h_recursion/super_liouville_torus_modular_cluster.py",
    "h_recursion/super_liouville_torus_one_point.py",
    "c_Recursion/super_liouville_structure_constants.py",
    "h_recursion/superconformal_torus_blocks.py",
    "c_Recursion/superconformal_blocks.py",
    "h_recursion/mixed_ramond_sphere_blocks.py",
    "h_recursion/ramond_sphere_blocks.py",
    "h_recursion/self_dual_superconformal_blocks.py",
)
DEFAULT_CONFIG = (
