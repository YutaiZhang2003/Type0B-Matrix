...
Since \(a_i\) is fixed, replacing \(H+a_i\) by \(H\) in the leading Gram
matrices and vertices changes only subleading terms.  The inverse Gram
matrices are diagonal in the orthogonal basis, so
\begin{equation}
 \begin{split}
 \F^{\NS}_{\boldsymbol\eta}
 \longrightarrow{}&
 ...
 \frac{
 \rho_0\!\left(
 \boldsymbol\ell_{-\mathsf A_i}\phi_H,
 \phi_{d_i},
 \boldsymbol\ell_{-\mathsf A_{i+1}}\phi_H
 \right)}
 {\mathcal N_{\mathsf A_i}(H)} ,
 \qquad
...
\(\#\mathsf C>\#\mathsf A\).  Then
\begin{equation}
 \begin{split}
 &\rho_0\!\left(
 \boldsymbol\ell_{-\mathsf A}\phi_H,
 \phi_d,
 \boldsymbol\ell_{-\mathsf B}\phi_H
 \right)
 \\
 &\qquad=
 \sum_{\substack{
 ...
 f^{\mathsf A}_{\mathsf C}
 f^{\mathsf B}_{\mathsf D}
 \rho_0\!\left(
 \mathbf L_{-\mathsf C}\phi_H,
 \phi_d,
 \mathbf L_{-\mathsf D}\phi_H
 \right).
 \end{split}
