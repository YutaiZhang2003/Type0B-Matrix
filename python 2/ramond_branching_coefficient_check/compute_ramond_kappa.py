"""Historical even-primary computation of the Ramond branching factor.

This archived calculator is not the authoritative Ward implementation.  New
work uses the mandatory-``p_phi`` generalized Ward system in
...
class PhysicalNRREvaluator:
    """Legacy even-primary evaluator retained for historical replay."""
