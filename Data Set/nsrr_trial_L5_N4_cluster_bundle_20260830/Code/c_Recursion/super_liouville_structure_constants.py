...
def ns_structure_constant_mp(
    p1: Number, p2: Number, p3: Number
) -> mpmath.mpc:
    """Return ``C(P1,P2,P3)`` in the active mpmath precision context."""
    ...
    return mpmath.mpc(0.5j) * numerator / denominator
...
def ns_tilde_structure_constant_mp(
    p1: Number, p2: Number, p3: Number
) -> mpmath.mpc:
    """Return ``tilde C(P1,P2,P3)`` in the active mpmath precision context."""
    ...
    return mpmath.mpc(1j) * numerator / denominator
